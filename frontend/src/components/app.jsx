...
export default class app extends Component {
    constructor(props) {
      ...
      /**
       * when there is a new member, synchronise with other users
       */
      componentDidUpdate () {
        this.scrollToBottom()
        socket.on('nbrMembre', data => {
            this.setState({membre_nbr:data})
            console.log("le nombre de personne dans le groupe : ",this.state.membre_nbr)
        })
      }
    ...
    componentDidMount(){   
        ...
        socket.on('temps', data => {
            ...
            if(this.state.first == true && this.state.curtime != 0){
                this.state._event.target.seekTo(this.state.curtime)
                this.setState({first:false})
            }
        })
        /**
         * synchronise event beetween boss and members of the group
         */
    ...
    /**
     * manage event do with the iframe video
     * @param {object} event iframe event
     */
    _onStateChange(event){
      ...
      /**
       * animation function of share the room
       */
      linkClicked = async () =>{
          //console.log("lol")
      ...
      /**
       * function to copy the url of the room
       */
      copy = () => {
    ...
    render() {
        ...
        let copylink = this.state.copy ? "box-inps-true" : "box-inps-false";
            ...
            return (
                ...
                <div className="app-part-droite" className={blur}>
                    <div className="app-chatroom">
                        ...
                        <div className='lien'>
                            <div className='link-box' onClick={this.linkClicked}>
                                <div className='copylink'>
                                    <div className={copylink}>
                                        <input className='linktocopie'
                                            type="text"
                                            value={"https://youtubeparty.vercel.app/app/"+this.props.match.params.roomid+"/"+this.props.match.params.vurl}
                                            id="myInput"
                                        />
                                        <button onClick={this.copy} className="copytextbutton">Copy</button>
                                    </div>
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon-link" width="24" height="24" viewBox="0 0 24 24" stroke-width="2.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
